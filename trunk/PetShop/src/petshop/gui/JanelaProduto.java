...
public class JanelaProduto extends Janela {
    ...
    public JanelaProduto(TipoJanela tipo, Produto p) {
        ...
        campoCodigo.setDocument(new DocumentoMascara(9));
    ...
    private void initComponents() {
        ...
        labelEstoque.setFont(new java.awt.Font("Ubuntu", 1, 12)); // NOI18N
        ...
        labelPrecoCusto.setFont(new java.awt.Font("Ubuntu", 1, 12)); // NOI18N
        ...
        labelInformacoes.setFont(new java.awt.Font("Ubuntu", 0, 12)); // NOI18N
        ...
        labelPrecoVenda.setFont(new java.awt.Font("Ubuntu", 1, 12)); // NOI18N
